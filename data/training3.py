...
data.append(('stocks/yahoofinance', [
    ('file:html/stocks/yahoofinance/1.html', ['30.420', '31.670', '30.010']),
    ('file:html/stocks/yahoofinance/2.html', ['45.010', '45.400', '44.300']),
    ('file:html/stocks/yahoofinance/3.html', ['26.150', '25.700', '25.150']),
    ('file:html/stocks/yahoofinance/4.html', ['18.710', '18.980', '18.410']),
    ('file:html/stocks/yahoofinance/5.html', ['4.380', '4.380', '4.380']),
    ('file:html/stocks/yahoofinance/6.html', ['23.210', '23.510', '23.590']),
]))

data.append(('weather/bom', [
...
data.append(('news/theaustralian', [
...
data.append(('film/rottentomatoes', [
...
data.append(('commerce/ebay', [
    ('file:html/commerce/ebay/1.html', ["action", "LOT 2 Mary Kay TimeWise Targeted-Action Line Reducer", "$31.00", "NASCAR 2008 Ford Fusion Action COT 1/64th Scale Car", "$1.25", "Lot of Batman and Superman animated action figures.", "$5.00"]),
    ('file:html/commerce/ebay/2.html', ["action adventure", "NEW NINTENDO WII FIT GAME BALANCE BOARD +GAMES", "$100.00", "THE BEST AMOS 'N ANDY ANYWHERE! All 79 TV SHOWS. EXTRAS", "$39.95", " Icon-The Complete Miniseries-Swayze-NEW-FREE SHIPPING!!", "$7.98"]),
    ('file:html/commerce/ebay/3.html', ["adult", "Sexy French Maid Adult Halloween Costume Mini dress", "$19.37", " Aussie Lingerie 2 Pr Adult Hot FishNet Sock White+Black", "$0.77", "Adult Mature Brass Corkscrew Bottle Opener New In Box", "$8.95"]),
    ('file:html/commerce/ebay/4.html', ["adventure", "FOR VERIZON ADVENTURE MOTOROLA V750 NEW COVER CASE+CLIP", "$9.99", "Leather Case Pouch for Verizon Motorola Adventure v750", "$5.12", "CAR CHARGER+CASE for VERIZON MOTOROLA V750 ADVENTURE", "$8.99"]),
    ('file:html/commerce/ebay/5.html', ["africa", "Enlarge British Africa - South Africa #B1-4 MH-LH VF CV $48.25", "$12.15", "British Africa - South Africa #C5-6 MLH VF CV $36.00", "$9.15", "29.44cts 26x27mm PICTURE JASPER PEAR CAB AFRICA $NR!", "$0.99"]),
    ('file:html/commerce/ebay/6.html', ["african-american fiction", "Breaking Ice -ANTHOLOGY OF AFRICAN AMERICAN FICTION", "$1.99", "Sweeter Than Honey M. Morrison african american fiction", "$7.99", "Can't Say No by Bette Ford african american fiction", "$2.99"]),
]))


data.append(('forum/ubuntuforum', [
