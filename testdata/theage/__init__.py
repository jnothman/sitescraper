...
"""]),
    ...
    ('7.html', ["""MELBOURNE'S weak property market got a shot in the arm at the weekend as speculation of a cut in official interest rates as early as next month helped to boost clearance rates and lift hopes of more aggressive bidding from formerly timid buyers.
    ...
    ('8.html', ["""MELBOURNE scientists have developed a drug that may prevent a condition responsible for up to 45% of all deaths in the Western world.
    ...
    ('9.html', ["""RESEARCH seen by The Age reveals widespread support for decriminalising abortion, even in some of the most controversial circumstances. These include when the baby is physically or mentally disabled.
    ...
    ('10.html', ["""FORMER deputy premier John Thwaites made 17 taxpayer-funded visits to Victoria's snowfields and national parks between 2003 and his shock resignation last year.
    ...
    ('11.html', ["""HE WAS once rich, charismatic and well connected. Now Tony Mokbel is finding out quickly that his once impressive list of friends and business associates is shrinking by the day.
    ...
    ('12.html', ["""TELEVISION host and actress Tania Zaetta is suing the publisher of The Daily Telegraph over an article that claimed the Defence Department was investigating an allegation she had sex with troops stationed in Afghanistan during a concert tour.
    ...
    ('13.html', ["""A FORMER  naval seaman who celebrated his 17th birthday a week before being part of the 1964 Voyager disaster has won a six-figure sum in settlement of his damages claim resulting from the collision.
